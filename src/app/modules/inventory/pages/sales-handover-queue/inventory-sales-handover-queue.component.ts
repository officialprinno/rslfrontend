...
import { InvSoHandoverPanelComponent } from '../../components/inv-so-handover-panel/inv-so-handover-panel.component';
import { InventoryNavComponent } from '../../components/inventory-nav/inventory-nav.component';

@Component({
  selector: 'app-inventory-sales-handover-queue',
  imports: [
    RouterLink,
    PageHeaderComponent,
    InventoryNavComponent,
    InvSoHandoverPanelComponent,
    StatusBadgeComponent,
    TableSkeletonComponent,
    ErrorStateComponent,
  ],
  templateUrl: './inventory-sales-handover-queue.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InventorySalesHandoverQueueComponent implements OnInit {
  ...
  load(): void {
    ...
    this.inventory
      .getSalesOrdersForStockVerification('handover')
